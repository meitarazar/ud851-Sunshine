...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        mDetailBinding.icon.setImageResource(SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId));
        ...
        mDetailBinding.weatherDescription.setContentDescription(descriptionA11y);

        // COMPLETED (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.icon.setContentDescription(descriptionA11y);
        ...
        mDetailBinding.highTemperature.setContentDescription(highA11y);
        ...
        mDetailBinding.lowTemperature.setContentDescription(lowA11y);
        ...
        mDetailBinding.humidityLabel.setContentDescription(humidityA11y);
        ...
        mDetailBinding.windLabel.setContentDescription(windA11y);
        ...
        mDetailBinding.pressureLabel.setContentDescription(pressureA11y);
