    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (match) {
            ...
            case CODE_WEATHER_WITH_DATE:
                String qSelection = WeatherContract.WeatherEntry.COLUMN_DATE + " = ?";
                String[] qSelectionArgs = new String[] {uri.getLastPathSegment()};

                cursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, projection, qSelection, qSelectionArgs, null, null, sortOrder);
                break;
            default:
