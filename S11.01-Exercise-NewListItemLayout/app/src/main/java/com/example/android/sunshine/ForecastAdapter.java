...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        forecastAdapterViewHolder.weatherTempHighLow.setText(highAndLowTemperature);
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        final TextView weatherTempHighLow;
        ...
        ForecastAdapterViewHolder(View view) {
            ...
            weatherDesc = (TextView) view.findViewById(R.id.tv_weather_desc);
            weatherTempHighLow = (TextView) view.findViewById(R.id.tv_weather_temp_high_low);
